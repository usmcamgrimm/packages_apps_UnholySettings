...
public class ColorPickerFragment extends Fragment implements
    ...
    private static final int PALETTE_UNHOLY  = 0;
    ...
    private void setUpPaletteColorButtons() {
        ...
        TypedArray colors = mResources.obtainTypedArray(R.array.color_picker_unholy_palette);
        ...
        for (int i=0; i<3; i++) {
            ...
            int titleResId = R.string.palette_unholy_title;
